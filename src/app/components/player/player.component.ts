...
export class PlayerComponent {
  ...
  isMinimised = true;
  selectedAudio: SelectedAudioInterface = { url: '', genre: '', type: '', title: '', videoId: '', albumArt: '', author: '', lengthSeconds: 0, videoThumbnails: [] };

  constructor(private queue: QueueService, private notification: NotificationService) {
    ...
    fromEvent(this.player, 'error')
      .subscribe(() => {
        this.notification.notifyUser('Error: This media cannot be played. Please try another.');
        this.stopEmitting();
      })
